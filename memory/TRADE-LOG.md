...
**Notes:** Strong Friday — AMD surged +11.71% on broad tech/semis rally, pushing phase P&L through +10% milestone (+10.27%). AMZN and TXN up modestly (+0.64%, +0.63%). AMD HWM moved to $456.29 with stop now at $410.66. No stop tightening needed on any position yet. Trades this week: 1/3 (AMD May 7). Still underdeployed at 58.2% vs 75-85% target — cash $46K ready for 1-2 new entries. Pre-market Monday: scan for momentum entries to close deployment gap.
...
- Thesis: AMD intact (semis momentum); AMZN intact (AWS); TXN intact but heavy insider selling (CEO + 2 SVPs sold ~$17M combined in May) remains watch risk
...
### May 19 — AMD Stop-Out (GTC trailing stop triggered)
...
| Shares       | 50                                                                    |
| Entry Price  | $414.95                                                               |
| Exit Price   | ~$421.55 (10% trail GTC, stop $422.29, HWM $469.21)                  |
| P&L          | +$330 (+1.59%)                                                        |
| Notes        | Stop triggered at open May 19 after AMD closed $423.56 on May 15 with only $1.27 cushion above $422.29 stop. Profitable exit despite giving back most of the +12% peak gain. Cash jumped from $24,076 to $45,153 on proceeds. |

---

### May 19 — Midday Scan
**Portfolio:** $108,577.01 | **Cash:** $45,153.15 (41.6%) | **Deployment:** 58.4% ⚠️ | **Day P&L:** -$731.54 (-0.67%) | **Phase P&L:** +$8,577.01 (+8.58%)

#### Open Positions (midday)
| Ticker | Shares | Entry    | Now      | Unreal P&L          | Stop                                    |
|--------|--------|----------|----------|---------------------|-----------------------------------------|
| AMZN   | 78     | $260.30  | $255.96  | -$339 (-1.67%) ⚠️  | 10% trail, HWM $278.56, stop $250.70   |
| NVDA   | 101    | $218.04  | $221.10  | +$309 (+1.40%)      | 10% trail, HWM $236.54, stop $212.89   |
| TXN    | 70     | $267.28  | $301.76  | +$2,414 (+12.90%)   | 7% trail, HWM $310.29, stop $288.57    |

**Actions:**
- Losers: None at -7%. AMZN -1.67% — watch; stop $250.70 only $5.26 below current ($255.96).
- Stop tighten: None. TXN already at 7% trail (prior tighten); not yet at +20% ($320.74). NVDA/AMZN below thresholds.
- Thesis: All intact per last research. AMZN -3.36% intraday flagged — Perplexity unavailable to check catalyst.
- Research: PERPLEXITY_API_KEY not set — skipped.
- **Deployment: 58.4% — UNDERDEPLOYED vs 75-85% target. AMD stop-out freed ~$21K. Need 1-2 new entries.**

---

### May 20 — Market-Open Snapshot
**Portfolio:** $109,145.15 | **Cash:** $45,153.15 (41.4%) | **Deployment:** 58.6% | **Phase P&L:** +$9,145.15 (+9.15%)
...
**Notes:** AMD stopped out automatically (May 15–19 window); stop at $422.29 triggered on continued pullback from $469.21 HWM. Small realized gain (+1.77%) — stop worked as designed, protecting capital from a deeper reversal. Deployment dropped from 78% to 58.6%. **NVDA reports Q1 FY2027 earnings tonight after close** — binary event; holding existing position with 10% trail stop at $212.89. No new trades today. Week trades: 0/3. Pre-market tomorrow: evaluate entries post-NVDA reaction to close deployment gap (58.6% → 75-85%).

---

### May 20 — Midday Scan
**Portfolio:** $109,646.08 | **Cash:** $45,153.15 (41.2%) | **Day P&L:** +$821.10 (+0.75%) | **Phase P&L:** +$9,646.08 (+9.65%)

#### Open Positions (midday)
| Ticker | Shares | Entry   | Now     | Unreal P&L        | Stop                                      |
|--------|--------|---------|---------|-------------------|-------------------------------------------|
| AMZN   | 78     | $260.30 | $264.58 | +$334 (+1.64%)    | 10% trail, HWM $278.56, stop $250.70     |
| NVDA   | 101    | $218.04 | $224.96 | +$699 (+3.18%)    | 10% trail, HWM $236.54, stop $212.89     |
| TXN    | 70     | $267.28 | $301.94 | +$2,426 (+12.97%) | 7% trail, HWM $310.29, stop $288.57      |

**Actions:**
- Losers: None — all positive. No cuts.
- Stop tighten: None — AMZN +1.6%, NVDA +3.2% (both far below +15%); TXN +13.0% on 7% trail (need $320.74 for 5% tighten)
- Thesis: AMZN intact (AWS); NVDA intact (AI inference); TXN intact (analog recovery, Q1 beat)
- AMD: Confirmed stopped out week of May 19; exit documented above
- Research: Perplexity unavailable (key not set)
- **Deployment: 58.8% — underdeployed vs 75-85% target. 1-2 new positions needed pre-market.**
...
| Ticker | Shares | Entry    | Close    | Day Chg  | Unrealized P&L          | Stop                                     |
|--------|--------|----------|----------|----------|-------------------------|------------------------------------------|
| AMZN   | 78     | $260.30  | $265.02  | +2.19%   | +$367.94 (+1.81%)       | 10% trail, HWM $278.56, stop $250.70    |
...
### May 26 — Stop-Out: NVDA + New Entry: AMD

#### Trade Exit — NVDA (10% trailing stop triggered)
| Field        | Value                                               |
|--------------|-----------------------------------------------------|
| Date         | 2026-05-26                                          |
| Ticker       | NVDA                                                |
| Side         | SELL (auto stop-out)                                |
| Shares       | 101                                                 |
| Entry Price  | $218.04 (May 11)                                    |
| Exit Price   | $212.71 (10% trail, HWM $212.71)                   |
| Realized P&L | **-$538 (-2.45%)**                                 |
| Notes        | Stop triggered as NVDA pulled back from HWM. Small loss — stop worked as designed. |

#### New Trade Entry — AMD (re-entry)
| Field        | Value                                                                                         |
|--------------|-----------------------------------------------------------------------------------------------|
| Date         | 2026-05-26                                                                                    |
| Ticker       | AMD                                                                                           |
...
| Shares       | 41                                                                                            |
| Entry Price  | $486.02                                                                                       |
| Stop Level   | 10% trailing GTC                                                                              |
| Thesis       | AMD re-entry: post-earnings semis momentum continued; prior stop-out was a win (+1.59%); no sector penalty |
| Target       | $583 (+20%)                                                                                   |
| R:R          | 2.0:1                                                                                         |
| Week Trades  | 1/3 (week of May 25–29)                                                                       |

---

### May 27 — Stop-Out: TXN + New Entry: NVDA

#### Trade Exit — TXN (7% trailing stop triggered)
| Field        | Value                                               |
|--------------|-----------------------------------------------------|
| Date         | 2026-05-27                                          |
| Ticker       | TXN                                                 |
| Side         | SELL (auto stop-out)                                |
| Shares       | 70                                                  |
| Entry Price  | $267.28 (Apr 28)                                    |
| Exit Price   | $314.78 (7% trail, HWM $310.29)                    |
| Realized P&L | **+$3,325 (+17.78%)**                              |
| Notes        | Excellent exit — 7% trail (tightened from 10% at +15%) captured strong gain from 8-week hold. |

#### New Trade Entry — NVDA (re-entry)
| Field        | Value                                                                                         |
|--------------|-----------------------------------------------------------------------------------------------|
| Date         | 2026-05-27                                                                                    |
| Ticker       | NVDA                                                                                          |
...
| Entry Price  | $211.60                                                                                       |
| Stop Level   | 10% trailing GTC                                                                              |
| Thesis       | NVDA re-entry at lower price; AI inference supercycle intact; sector diversification within AI |
| Target       | $253.92 (+20%)                                                                                |
| R:R          | 2.0:1                                                                                         |
| Week Trades  | 2/3 (week of May 25–29)                                                                       |

---

### May 29 — New Entry: XLB

#### New Trade Entry — XLB (Materials ETF)
| Field        | Value                                                                                         |
|--------------|-----------------------------------------------------------------------------------------------|
| Date         | 2026-05-29                                                                                    |
| Ticker       | XLB                                                                                           |
...
| Shares       | 430                                                                                           |
| Entry Price  | $51.36                                                                                        |
| Stop Level   | 10% trailing GTC (HWM $53.31, stop $47.98)                                                   |
| Thesis       | Materials sector #1 YTD momentum (+22%); non-correlated to tech/AI; ETF diversifies single-stock risk; closes deployment gap |
| Target       | $61.63 (+20%)                                                                                 |
| R:R          | 2.0:1                                                                                         |
| Week Trades  | 3/3 (week of May 25–29)                                                                       |

---

### Jun 03 — Stop-Out: AMZN

#### Trade Exit — AMZN (10% trailing stop triggered)
| Field        | Value                                               |
|--------------|-----------------------------------------------------|
| Date         | 2026-06-03                                          |
| Ticker       | AMZN                                                |
| Side         | SELL (auto stop-out)                                |
| Shares       | 78                                                  |
| Entry Price  | $260.30 (Apr 30)                                    |
| Exit Price   | $250.65 (10% trail, HWM $278.56)                   |
| Realized P&L | **-$753 (-3.71%)**                                 |
| Notes        | AWS thesis remained intact but stock pulled back through stop. 35-day hold; stop protected from worse loss. |

---

### Jun 05 — Stop-Outs: AMD + NVDA

#### Trade Exit — AMD (10% trailing stop triggered)
| Field        | Value                                               |
|--------------|-----------------------------------------------------|
| Date         | 2026-06-05                                          |
| Ticker       | AMD                                                 |
| Side         | SELL (auto stop-out)                                |
| Shares       | 41                                                  |
| Entry Price  | $486.02 (May 26)                                    |
| Exit Price   | $491.43 avg (10% trail, 2-fill stop)               |
| Realized P&L | **+$222 (+1.11%)**                                 |
| Notes        | Short 10-day hold; trailing stop captured small gain on volatile semis move. |
...
| Side         | SELL (auto stop-out)                                |
| Shares       | 94                                                  |
| Entry Price  | $211.60 (May 27)                                    |
| Exit Price   | $209.04 (10% trail, HWM ~$232.27)                  |
| Realized P&L | **-$241 (-1.21%)**                                 |
| Notes        | 9-day hold; NVDA pulled back from new HWM; stop triggered cleanly. |

---

### Jun 08 — New Entries: NVDA + XLI + XLV

#### New Trade Entry — NVDA
| Field        | Value                                                                                         |
|--------------|-----------------------------------------------------------------------------------------------|
| Date         | 2026-06-08                                                                                    |
| Ticker       | NVDA                                                                                          |
...
| Shares       | 102                                                                                           |
| Entry Price  | $208.85                                                                                       |
| Stop Level   | 10% trailing GTC (HWM $212.71, stop $191.44)                                                 |
| Thesis       | AI inference supercycle; datacenter capex; lower cost basis than prior entries; sector leadership |
| Target       | $250.62 (+20%)                                                                                |
| R:R          | 2.0:1                                                                                         |
| Week Trades  | 1/3 (week of June 8–12)                                                                       |

#### New Trade Entry — XLI (Industrials ETF)
| Field        | Value                                                                                         |
|--------------|-----------------------------------------------------------------------------------------------|
| Date         | 2026-06-08                                                                                    |
| Ticker       | XLI                                                                                           |
...
| Shares       | 123                                                                                           |
| Entry Price  | $174.56                                                                                       |
| Stop Level   | 10% trailing GTC (HWM $182.92, stop $164.63)                                                 |
| Thesis       | Industrials sector YTD momentum; non-tech diversification; low AI correlation; infrastructure spend |
| Target       | $209.47 (+20%)                                                                                |
| R:R          | 2.0:1                                                                                         |
| Week Trades  | 2/3 (week of June 8–12)                                                                       |

#### New Trade Entry — XLV (Healthcare ETF)
| Field        | Value                                                                                         |
|--------------|-----------------------------------------------------------------------------------------------|
| Date         | 2026-06-08                                                                                    |
| Ticker       | XLV                                                                                           |
...
| Shares       | 139                                                                                           |
| Entry Price  | $153.39                                                                                       |
| Stop Level   | 10% trailing GTC (HWM $155.16, stop $139.64)                                                 |
| Thesis       | Healthcare sector momentum; defensive diversification; non-correlated to semis/AI risk       |
| Target       | $184.07 (+20%)                                                                                |
| R:R          | 2.0:1                                                                                         |
| Week Trades  | 3/3 (week of June 8–12)                                                                       |

---

### Jun 18 — EOD Snapshot (last trading day before Juneteenth holiday)
**Portfolio:** $108,810.99 | **Cash:** $22,023.78 (20.2%) | **Deployment:** 79.8% ✓ | **Phase P&L:** +$8,810.99 (+8.81%)**

| Ticker | Shares | Entry    | Close Jun 18 | Unrealized P&L       | Stop (GTC)                                |
|--------|--------|----------|--------------|----------------------|-------------------------------------------|
...
**Notes:** June 19 = Juneteenth holiday (market closed); June 20 = Saturday. Next trading day: Monday June 23. Week trades (Jun 16–20): 0/3. All 4 GTC trailing stops confirmed live. XLV at -2.60% — watch Monday for thesis check and -7% cut level ($142.65). NVDA after-hours Jun 18 showed elevated ask ($231.80) — potential gap-up at Monday open; watch +15% tighten trigger ($240.18).
